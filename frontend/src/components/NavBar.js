...
import resume from '../assets/Resume for placement pdf version.pdf';
        ...
        <Navbar expand="lg" className={scrolled ? "scrolled" : ""}>
            <Container>
                <Navbar.Brand href="#home">
                    <img className="logoImage" src={noddylogo} alt="Logo" />
                </Navbar.Brand>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <span className="navbar-text">
                        ...
                        <a id="letsconnect" href="#connect" className="vvd" onClick={() => console.log('connect')}><span>Let's Connect</span></a>
                    </span>
                </Navbar.Collapse>
            </Container>
        </Navbar>
